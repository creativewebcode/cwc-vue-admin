<template>
  <CWCCard ref="preview" v-bind:title="title" v-bind:example="true">
...
<script>
import CWCCard from "@/view/content/Card.vue";
import CWCLayoutExamples from "@/assets/js/layout/extended/examples.js";
...
export default {
  ...
  mounted() {
    // init example codes
    this.$nextTick(() => {
      CWCLayoutExamples.init([this.$el]);
