  ...
  <div class="card card-custom bg-gray-100 card-stretch gutter-b">
    ...
    <div class="card-header border-0 bg-danger py-5">
      <h3 class="card-title font-weight-bolder text-white">
        {{ $t("GENERAL.DASHBOARD.SALES_STAT") }}
      </h3>
      <div class="card-toolbar">
        <CWCSalesStat></CWCSalesStat>
      </div>
    </div>
    <!--end::Header-->
    <!--begin::Body-->
        ...
        <div class="row m-0">
          <div class="col bg-light-warning px-6 py-8 rounded-xl mr-7 mb-7">
            ...
            <a href="#" class="text-warning font-weight-bold font-size-h6">
              {{ $t("GENERAL.DASHBOARD.WEEKLY_SALES") }}
            </a>
          </div>
        ...
        <div class="row m-0">
          <div class="col bg-light-danger px-6 py-8 rounded-xl mr-7">
            ...
            <a href="#" class="text-danger font-weight-bold font-size-h6 mt-2">
              {{ $t("GENERAL.DASHBOARD.ITEM_ORDERS") }}
            </a>
          </div>
          <div class="col bg-light-success px-6 py-8 rounded-xl">
            ...
            <a href="#" class="text-success font-weight-bold font-size-h6 mt-2">
              {{ $t("GENERAL.DASHBOARD.BUG_REPORTS") }}
            </a>
          </div>
        </div>
        <!--end::Row-->
...
<script>
import CWCSalesStat from "@/view/Components/SalesStat/CWCSalesStat.vue";
