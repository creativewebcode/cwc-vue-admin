  ...
  <div class="topbar-item">
    ...
    >
      ...
      >
              ...
              <a href="#" class="navi-item">
                <span class="navi-link p-0 pb-2">
                  ...
                  <span class="navi-text text-muted text-hover-primary">
                    admin@creativewebcode.com
                  </span>
                </span>
              </a>
            </div>
            <button class="btn btn-light-primary btn-bold" @click="onLogout">
              {{ $t("AUTH.GENERAL.SIGN_OUT") }}
            </button>
          </div>
        </div>
        <!--end::Header-->
        ...
        <div class="navi navi-spacer-x-0 p-0">
          ...
          >
            <div class="navi-link">
              ...
              <div class="navi-text">
                <div class="font-weight-bold">{{ $t("PROFILE.MY_TASKS") }}</div>
        ...
        <div>
          <!--begin:Heading-->
          <h5 class="mb-5">{{ $t("PROFILE.RECENT_NOTIFICATIONS") }}</h5>
          <!--end:Heading-->
...
import CWCLayoutQuickUser from "@/assets/js/layout/extended/quick-user.js";
import CWCOffcanvas from "@/assets/js/components/offcanvas.js";
...
export default {
  ...
  mounted() {
    ...
    CWCLayoutQuickUser.init(this.$refs["cwc_quick_user"]);
  },
  methods: {
    onLogout() {
      this.$store
    ...
    closeOffcanvas() {
      new CWCOffcanvas(CWCLayoutQuickUser.getElement()).hide();
    }
  },
  computed: {
    picture() {
