...
import CWCLayoutHeaderTopbar from "@/assets/js/layout/base/header-topbar.js";

export default {
  name: "CWCHeaderMobile",
  components: {},
  mounted() {
    // Init Header Topbar For Mobile Mode
    CWCLayoutHeaderTopbar.init(this.$refs["kt_header_mobile_topbar_toggle"]);
  },
  computed: {
