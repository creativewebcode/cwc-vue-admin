<template>
  <!-- begin:: Aside -->
  <div class="brand flex-column-auto" id="kt_brand" ref="cwc_brand">
...
import CWCLayoutBrand from "@/assets/js/layout/base/brand.js";
import CWCLayoutAsideToggle from "@/assets/js/layout/base/aside-toggle.js";

export default {
  name: "CWCBrand",
  mounted() {
    // Init Brand Panel For Logo
    CWCLayoutBrand.init(this.$refs["cwc_brand"]);

    // Init Aside Menu Toggle
    CWCLayoutAsideToggle.init(this.$refs["cwc_aside_toggle"]);
  },
  methods: {
    siteLogo() {
