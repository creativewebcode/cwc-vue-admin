...
import CWCBrand from "@/view/layout/brand/Brand.vue";

import CWCLayoutAside from "@/assets/js/layout/base/aside.js";
import CWCLayoutAsideMenu from "@/assets/js/layout/base/aside-menu.js";
import CWCMenu from "@/view/layout/aside/Menu.vue";
...
export default {
  ...
  mounted() {
    this.$nextTick(() => {
      // Init Aside
      CWCLayoutAside.init(this.$refs["kt_aside"]);

      // Init Aside Menu
      CWCLayoutAsideMenu.init(this.$refs["kt_aside_menu"]);
    });
  },
  methods: {
    /**
