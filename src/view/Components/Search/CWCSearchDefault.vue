<template>
  ...
  >
    <form method="get" class="quick-search-form">
      ...
      >
        ...
        <input
          ...
          :placeholder="$tc(`ECOMMERCE.COMMON.SEARCH`)"
        />
    ...
    <CWCSearchResult v-bind:data="data"></CWCSearchResult>
  </div>
</template>

<script>
import CWCSearchResult from "@/view/Components/Search/CWCSearchResult.vue";

export default {
  name: "CWCSearchDefault",
  components: { CWCSearchResult },
  data() {
    return {
      data: [],
      loading: false,
