          ...
          <div class="wizard-steps p-8 p-lg-10">
            ...
            >
              <div class="wizard-label">
                ...
                <h3 class="wizard-title">
                  1. {{ $t("GENERAL.WIZARD.SETUP_LOCATION") }}
                </h3>
              </div>
            ...
            <div class="wizard-step" data-wizard-type="step">
              <div class="wizard-label">
                ...
                <h3 class="wizard-title">
                  2. {{ $t("GENERAL.WIZARD.ENTER_DETAILS") }}
                </h3>
              </div>
              <i class="wizard-arrow flaticon2-next"></i>
            </div>
            <div class="wizard-step" data-wizard-type="step">
              <div class="wizard-label">
                ...
                <h3 class="wizard-title">
                  3. {{ $t("GENERAL.WIZARD.SELECT_SERVICES") }}
                </h3>
              </div>
              <i class="wizard-arrow flaticon2-next"></i>
            </div>
            <div class="wizard-step" data-wizard-type="step">
              <div class="wizard-label">
                ...
                <h3 class="wizard-title">
                  4. {{ $t("GENERAL.WIZARD.DELIVERY_ADDRESS") }}
                </h3>
              </div>
              <i class="wizard-arrow flaticon2-next"></i>
            </div>
            <div class="wizard-step" data-wizard-type="step">
              <div class="wizard-label">
                ...
                <h3 class="wizard-title">
                  5. {{ $t("GENERAL.WIZARD.REVIEW_AND_SUBMIT") }}
                </h3>
              </div>
...
import CWCUtil from "@/assets/js/components/util";
import CWCWizard from "@/assets/js/components/wizard";
import Swal from "sweetalert2";

export default {
  name: "Wizard",
  mounted() {
    this.$store.dispatch(SET_BREADCRUMB, [{ title: "Setup Wizard" }]);
    // Initialize form wizard
    const wizard = new CWCWizard("kt_wizard_v1", {
