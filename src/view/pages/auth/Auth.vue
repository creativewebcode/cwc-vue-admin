      ...
      >
        ...
        <div class="d-flex flex-row-fluid flex-column justify-content-between">
          ...
          <a href="#" class="flex-column-auto">
            <img src="media/logos/logo-letter-1.png" class="" />
          </a>
          <!--end: Aside header -->
          <!--begin: Aside content -->
          <div
          ...
          >
            <h3 class="font-size-h1 mt-10 mb-5 text-white">
              Welcome to Creative Web Code!
            </h3>
            <p class="font-weight-lighter text-white opacity-80">
              The ultimate Bootstrap, Angular 8, React &amp; VueJS admin theme
              framework for next generation web apps. This case vue :)
            </p>
          </div>
          <!--end: Aside content -->
          ...
          >
            <div class="opacity-70 font-weight-bold text-white">
              © 2020 Creative Web Code
            </div>
            <div class="d-flex">
              <a href="#" class="text-white">
                {{ $t("AUTH.GENERAL.PRIVACY") }}
              </a>
              <a href="#" class="text-white ml-10">
