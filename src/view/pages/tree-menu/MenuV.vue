<template>
  <div>
    ...
    <div class="row">
      <div class="col-md-12">
        <CWCCodePreview v-bind:title="'Type'">
        ...
        <CWCCodePreview v-bind:title="'Colored Border'">
          <template v-slot:preview>
            <div>
              <v-alert
                border="left"
    ...
    <div class="row">
      <div class="col-md-12">
        <CWCCodePreview v-bind:title="'Border'">
          <template v-slot:preview>
            <div>
        ...
        <CWCCodePreview v-bind:title="'Dismissible'">
          <template v-slot:preview>
            <div>
              <v-alert
                v-model="alert"
...
<script>
import CWCCodePreview from "@/view/content/CodePreview.vue";
